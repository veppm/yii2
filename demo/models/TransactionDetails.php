 ...
 * @property string $transanction_id
...
class TransactionDetails extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['contest_id', 'order_id', 'transanction_id', 'transaction_amount', 'payment_status', 'payment_date'], 'required'],
            [['contest_id', 'order_id', 'payment_date'], 'integer'],
            [['payment_status', 'paypal_records'], 'string'],
            [['transanction_id'], 'string', 'max' => 200],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'order_id' => 'Order ID',
            'transanction_id' => 'Transanction ID',
