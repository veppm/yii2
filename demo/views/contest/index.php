                ...
                <div class="gellery">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="gellery-img">
                                <label>
                                    <img src="<?=Url::base(true)?>/user-assets/images/building-sites/<?= $i ?>.jpg" alt="building-site<?=$i?>" class="building-site-img img-responsive control-wid-ht" data-icon="<?=$i;?>">
                            ...
                            <div class="plus-icon" id="b-site-plus-icon-<?=$i;?>" >
                               <!--  <img src="<?php // echo Url::base(true) ?>/user-assets/images/ark_favi.png"> -->
                               <i class="fa fa-plus overlay-plus" aria-hidden="true"></i>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-10">
                                <div class="box__input">
                                    ...
                                    <label for="file"><strong>Choose a image</strong><span class="box__dragndrop"> or drag it here</span>.</label>
                        ...
                        <div class="colored_box">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="box_2" id="design-packages-2" >
                                    <h2>Concept Design to Build <?=\Yii::$app->params['design_packages'][1];?></h2>
                                    <p>+ Full money back guarantee <!--  <br>+ Expect ~ 15 personalised concept designs  <br>+ --></p>
                                </div>
                                <input type="radio" name="ContestForm[design_packages]" class="hidden" value="<?=\Yii::$app->params['design_packages'][1];?>">
                                <div class="colored_btn2 package-btn">
                                    <button type="button" class="banner_btn progress_bar" data-page="seventh" data-seq="7">CONCEPT TO BULID</button>
                                </div>
                            </div>
                        </div>
                    </div>
