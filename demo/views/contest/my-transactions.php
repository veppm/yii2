					...
					<div class="db_box2 no_border_top proposal-section">
						<div class="db_d_box">
							<p class="won">
								...
								<a  href="javascript:void(0);" class="btn btn-success won-btn custome-btn">Success</a>
							</p> 
						</div>

						<div class="db_ul">
							<ul>
								<li><a href="javascript::void(0);" title="Paid Amount"><i class="far fa-money-bill-alt"></i> $<?=ucfirst($transaction['transaction_amount']);?></a></li>
								<li><a href="" title="Transaction Number"><i class="fas fa-list-alt"></i><?=$transaction['transaction_id'];?></a></li>
								<li><a href="" title="Transaction Date"><i class="far fa-calendar-alt"></i><?=Yii::t('user', '{0, date, dd MMMM YYYY }', $transaction['payment_date']);?></a></li>
							</ul>
						</div>
					</div>
				</div> 
