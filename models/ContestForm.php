...
class ContestForm extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /*
      send payment success message to both user and admin
    */
    public static function sendPaymentMail($to, $mailData)
    {
        $mailer   = new Mailler(); 
        $mailer->sendSuccessPaymentMessage($to, $mailData);
        return  $mailer->sendSuccessPaymentMessage(\Yii::$app->params['adminEmail'], $mailData, 'admin');
    }
