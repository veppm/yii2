			...
			?>
				<div class="user_content1">
					<div class="db_box2 no_border_top proposal-section">
						<div class="db_d_box">
							<p class="won">
								<a title="Contest Name" href="<?=Url::base()?>/contest/contest-information?contest-proposal=<?=$transaction['id']?>"> <?=ucfirst($transaction['contest_title']);?> </a> 
						...
						<div class="db_ul">
							<ul>
								<li><a href="javascript::void(0);" title="Paid Amount"><i class="far fa-money-bill-alt"></i> $<?=($transaction['tn_transaction_amount']) ? number_format($transaction['tn_transaction_amount'],2) : number_format($transaction['design_package'],2) ;?></a></li>
								<li><a href="" title="Transaction Number"><i class="fas fa-list-alt"></i><?=($transaction['transaction_id']) ? $transaction['transaction_id'] : ' --- ';?> </a></li>
								<li><a href="" title="Transaction Date"><i class="far fa-calendar-alt"></i><?=($transaction['tn_payment_date']) ? Yii::t('user', '{0, date, dd MMMM YYYY }', $transaction['tn_payment_date']) : Yii::t('user', '{0, date, dd MMMM YYYY }', $transaction['payment_date']) ;?></a></li>
							</ul>
						</div>
					</div>
				</div> 
