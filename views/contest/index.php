...
<?php //  $form->field($model, 'file')->fileInput() ?>
    <div class="tabbing-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="gellery-img">
                                <label>
                                    <img src="<?=Url::base(true)?>/user-assets/images/inspiration/<?= $i ?>.jpg" alt="inspiration<?=$i?>" class="inspiration-img img-responsive control-wid-ht" data-icon="<?=$i;?>">
                                   
                                    <input type="checkbox" name="ContestForm[inspiration][]" id="inspiration_<?= $i ?>" value="images/inspiration/<?= $i ?>.jpg" class="hidden inspiration" autocomplete="off">
                                </label>
                            </div>
                            <div class="plus-icon" id="insp-plus-icon-<?=$i;?>" >
                                <!-- <img src="<?php // echo Url::base(true) ?>/user-assets/images/ark_favi.png"> -->
                                <i class="fa fa-plus overlay-plus" aria-hidden="true"></i>
                            </div>
                        </div>
                        <?php } ?>
                        <div class="btn">
            ...
            <div class="container-fluid">
                <div class="gellery">
                    <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="gellery-img" style="height: 900px;">
                                    <input id="building_site_map" class="controls form-control"  type="text" placeholder="Search Google Maps" name="ContestForm[building_site]" value="<?=$model->building_site;?>">
                        ...
                        <!-- <div class="col-md-4">
                            <div class="gellery-img">
                                <label>
                                   <img src="<?php // Url::base(true)?>/user-assets/images/building-sites/<?= $i ?>.jpg" alt="building-site<?=$i?>" class="building-site-img img-responsive control-wid-ht" data-icon="<?=$i;?>">
                                    <input type="checkbox" name="ContestForm[building_site][]" id="building_site_<?=$i?>" value="building-sites/<?= $i ?>.jpg" class="hidden building_site" autocomplete="off" >
                                </label>
                            </div>
                        </div> -->
                    </div>
                ...
                <div class="gellery">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="gellery-img">
                                <label>
                                    <img src="<?=Url::base(true)?>/user-assets/images/material-and-finishes/<?= $i ?>.jpg" alt="materials-finishes<?=$i?>" class="materials-finishes-img img-responsive control-wid-ht" data-icon="<?=$i;?>">
                                    <input type="checkbox" name="ContestForm[materials_finishes][]" id="materials_finishes<?=$i?>" value="images/material-and-finishes/<?= $i ?>.jpg" class="hidden materials_finishes" autocomplete="off">
                                </label>
                            </div>
                            <div class="plus-icon" id="m-finishes-plus-icon-<?=$i;?>" >
                               <!--  <img src="<?php // echo Url::base(true) ?>/user-assets/images/ark_favi.png"> -->
                                <i class="fa fa-plus overlay-plus" aria-hidden="true"></i>
                            </div>
                        </div>
                ...
                <div class="user_form"> 
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-10">
                                <div class="">
                                    <textarea rows="10" maxlength="200" name="ContestForm[about_situation_other]" class="form-control other-textbox" placeholder="E.g. Other needs that has not been listed."><?=$model->about_situation_other;?></textarea>
                                </div>
                            </div>
                        </div> 
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-10">
                                <div class="">
                                    <textarea rows="10" maxlength="200" name="ContestForm[about_family_other]" class="form-control other-textbox" placeholder="E.g. Just myself with my girlfriend that visits and my 2 dogs"><?=$model->about_family_other;?></textarea>
                                </div>
                            </div>
                        </div> 
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-10">
                                <div class="">
                                    <textarea rows="10"  maxlength="200" name="ContestForm[family_specific_need]" class="form-control other-textbox family_specific_need" placeholder="E.g. My husband needs a seperate workshop for his tools and boat and my grandparents"><?=$model->family_specific_need;?></textarea>
                                </div>
                            </div>
                        </div> 
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5">
                                <label class="radio">
                                    <input type="radio" value="<?=$bathroomsno?>" name="ContestForm[bathrooms_no]" class="hidden bathrooms_no" <?=($model->bathrooms_no==$bathroomsno) ? 'checked="checked"' : '';?>> 
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-10">
                                <div class="">
                                    <textarea rows="10" maxlength="200" name="ContestForm[living_spaces]" class="form-control other-textbox living_spaces" placeholder="E.g. We would like a living room for guest and entertaining and a seperate family room that doubles as a media room."><?=$model->living_spaces;?></textarea>
                                </div>
                            </div>
                        </div> 
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-10">
                                <div class="">
                                    <textarea rows="10" maxlength="200" name="ContestForm[additional_room]" class="form-control other-textbox additional_room" placeholder="E.g. We want a large study for the adults and a play area for the kids outside."><?=$model->additional_room;?></textarea>
                                </div>
                            </div>
                        </div> 
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-10">
                                <div class="">
                                    <textarea rows="10" maxlength="200" name="ContestForm[communicate_architects]" class="form-control other-textbox communicate_architects" placeholder="E.g. We really want the living spaces to look out onto a courtyard that has heaps of landscaping!"><?=$model->communicate_architects;?></textarea>
                                </div>
                            </div>
                        </div> 
                    </div>
                                ...
                                <div class="col-md-5">
                                    <label class="radio">
                                        ...
                                        <div class="label looking_build">
                                            <span for="looking_build"><?=$lookingBuild;?></span> <br>
                                        </div>
                                    </label>
                                </div>
                            <?php } ?>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-10">
                                <div class="box__input">
                                    ...
                                    <label for="file" id="dislay_sketche_name"><strong>Choose a image</strong><span class="box__dragndrop"> or drag it here</span>.</label>
        ...
        <div id="sixth" class="tab_div">
            <div class="container-fluid">
                <div class="h2_heading">
                    <h2>Contest Title and Design Package </h2>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="colored_box">
                            <div class="col-md-6">
                                <div class="h2_heading">
                                    <!-- <h2>Contest title? </h2> -->
                                    <h3>Write a descriptive contest title to attract more
                                      designers. This is the first thing designers will
                                      see!</h3>
                                    <div class="">
                                        <textarea maxlength="100" rows="10" name="ContestForm[contest_title]" class="form-control other-textbox contest_title" placeholder="E.g. Design our contemporary beach house!"><?=$model->contest_title;?></textarea> 
                                    </div>
                                </div>
                                <!-- <div class="box_1" id="design-packages-1">
                                    <h2>Concept Design <?=\Yii::$app->params['design_packages'][0];?></h2>
                                    <p>+ Full money back guarantee <br>+ Expect ~ 8 personalised  <br>concept designs</p>
                                </div>
                                <input type="radio" name="ContestForm[design_packages]" class="hidden" value="<?=\Yii::$app->params['design_packages'][0];?>">
                                <div class="colored_btn1 package-btn">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="box_2" id="design-packages-2" >
                                    <h2>Concept Design to Build <?=\Yii::$app->params['design_packages'][0];?></h2>
                                    <p>+ Full money back guarantee <!--  <br>+ Expect ~ 15 personalised concept designs  <br>+ --></p>
                                </div>
                                <input type="radio" name="ContestForm[design_package]" class="hidden" value="<?='0'?>" checked="checked">
                                <div class="colored_btn2 package-btn">
                                    <button type="button" class="banner_btn">CONCEPT TO BULID</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="h2_heading">
                    ...
                    <label class="radio">
                        ...
                        <div class="label guaranteed_contest_option">
                            <span for="guaranteed_contest_option"><?=$guaranteed_contest_option;?></span> <br>
                        </div>
                    </label>
                </div> 
                ...
                <div class="h2_heading">
                    ...
                    <div class="radio_bottom">
                         ...
                         <?php $contestDurations =  [
                            ...
                            ?>
                        <?php foreach ($contestDurations as  $key => $contestDuration) { ?>
                            <label class="control control--radio"> <?=$contestDuration;?> 
                                <input type="radio" value="<?=$key;?>" name="ContestForm[contest_duration]" class="contest_duration"
                                <?=($model->contest_duration==$key) ? 'checked="checked"' : '';?>>
                                ...
                                <div class="payment_heading">
                                    ...
                                    <div class="col-md-8">
                                        <div class="payment_para">
                                            ...
                                            <p class="pull-right para_2">$<?=\Yii::$app->params['design_packages'][0];?></p>
                                        </div>  
                                    </div>
                                </div>
                            </div>
...
$('#submit_button').click(function (e) {
    ...
    if(inspirationVal(requiredText, atleastOne)===false){
        return false;
    }
...
function building_site(requiredText, atleastOne, seq=8) {
   /*if(($('.building_site:checkbox:checked').length)<1 && seq>2){
    ...
    if($('#building_site_map').val()=='' && seq>2){
        $('#error_inspiration').html('Your building site '+requiredText);
        $('#error_inspiration').addClass('error_inspiration');
        $(window).scrollTop(0);
        return false;
    }
...
$(document).ready(function(e){
    /*$('#design-packages-2').click(function(){
        $(this).next('input[type=radio]').prop('checked', true);
        $('#design-packages-1').removeClass('box_12-checked');
        $(this).addClass('box_12-checked');

    })

    $('#design-packages-1').click(function(){
        $(this).next('input[type=radio]').prop('checked', true);
        $('#design-packages-2').removeClass('box_12-checked');
        $(this).addClass('box_12-checked');
    });*/
    ...
    $(".inspiration-img").click(function(){
        ...
        if (($("input[name*='inspiration']:checked").length)>7) {
            if($(this).next('input[type=checkbox]').is(":checked")===true){
                $('#insp-plus-icon-'+$(this).attr('data-icon')).toggleClass('plus-display');
                $(this).toggleClass("check");
            } else {
                alert(message);
                $('#insp-plus-icon-'+$(this).attr('data-icon')).removeClass('plus-display');
    ...
    /*$(".building-site-img").click(function(){
        ...
        if (($("input[name*='building_site']:checked").length)>7) {
            if($(this).next('input[type=checkbox]').is(":checked")===true){
                // $(this).next('input[type=checkbox]').prop('checked', false);
                $('#b-site-plus-icon-'+$(this).attr('data-icon')).toggleClass('plus-display');
                $(this).toggleClass("check");
            } else {
                alert(message);
                $('#b-site-plus-icon-'+$(this).attr('data-icon')).removeClass('plus-display');
                $(this).next('input[type=checkbox]').prop('checked', false);
                return false;
            }
        } else {
    ...
    // step-3 validation
        if (($("input[name*='materials_finishes']:checked").length)>7) {
            if($(this).next('input[type=checkbox]').is(":checked")===true){
                // $(this).next('input[type=checkbox]').prop('checked', false);
                $('#m-finishes-plus-icon-'+$(this).attr('data-icon')).toggleClass('plus-display');
                $(this).toggleClass("check");
            } else {
                alert(message);
                $('#m-finishes-plus-icon-'+$(this).attr('data-icon')).removeClass('plus-display');
                $(this).next('input[type=checkbox]').prop('checked', false);
                return false;
            }
        } else {
...
// sketch name display
$('.box__input #sketches').change(function () {
    $('#dislay_sketche_name').html(this.files['0'].name);
});
