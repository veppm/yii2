                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-8 textarea_comment">
                                        ...
                                        <textarea class="form-control other-textbox-info" placeholder="This can include anything from drawings, renders, plans, elevations and sections. Anything to convey the idea to the client clearly" name="ContestProposal[comment]" id="textarea_comment" readonly="readonly"><?= (!$formdata->comment) ? Yii::$app->request->get('proposal_comment') : $formdata->comment;?></textarea> 
