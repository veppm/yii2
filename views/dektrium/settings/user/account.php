...
<?= $this->render('@app/views/dektrium/profile/topBottom/top-body.php', ['profile'=>$model])  ?>
<div class="col-md-9">
	<div class="right_box">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-7">
                            <?= Html::submitButton(Yii::t('user', 'Save'), ['class' => 'btn btn-block btn-success  custome-btn']) ?><br>
                        </div>
                    </div>
                    <?php ActiveForm::end(); ?>
                </div>
