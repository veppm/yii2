      ...
      <div class="row">
          ...
          <div class="col-lg-9 col-md-9 col-sm-12">
            ...
            <ul class="nav navbar-nav ft_quick_links">
                  ...
                  <li><a href="<?=Url::base()?>/cms-pages/faqs">FAQs </a></li>
        ...
        <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-md-6">  
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="ContactForm[message]" id="message" placeholder="Question:" maxlength="200"></textarea>
          ...
          <div class="col-md-6">
            ...
            <ul class="nav quick_links">
                  ...
                  <li><a href="<?=Url::base()?>/cms-pages/about-us">About Us </a></li>
